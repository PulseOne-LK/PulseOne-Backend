...
func (x *PrescriptionDispensedEvent) Reset() {
	*x = PrescriptionDispensedEvent{}
	mi := &file_proto_user_events_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrescriptionDispensedEvent) Descriptor() ([]byte, []int) {
	return file_proto_user_events_proto_rawDescGZIP(), []int{5}
}
...
const file_proto_user_events_proto_rawDesc = "" +
	"\n" +
	"\x17proto/user_events.proto\x12\tevents.v1\"\xec\x02\n" +
...
var file_proto_user_events_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
